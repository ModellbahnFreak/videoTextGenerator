...
export class Migration1716369437668 implements MigrationInterface {
    name = 'Migration1716369437668'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "data_key" ("key" varchar NOT NULL, "value" text NOT NULL, "topicIdOrName" varchar NOT NULL, "version" integer NOT NULL, "createdByUuid" varchar, PRIMARY KEY ("key", "topicIdOrName"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_data_key" ("key" varchar NOT NULL, "value" text NOT NULL, "topicIdOrName" varchar NOT NULL, "version" integer NOT NULL, "createdByUuid" varchar, CONSTRAINT "FK_fcdd9c2da59975378be538b36a3" FOREIGN KEY ("topicIdOrName") REFERENCES "topic" ("idOrName") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1cdad5527326a407f52093e6f34" FOREIGN KEY ("createdByUuid") REFERENCES "client" ("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION, PRIMARY KEY ("key", "topicIdOrName"))`);
